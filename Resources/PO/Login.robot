...
*** Variables ***
${MY_ACCOUNT_DROPDOWN} =    css: a[data-target="Navbar-accountDropdown"]
${LOGIN_BUTTON} =   css: a.Navbar-accountDropdownButtonLink[data-analytics-placement="Nav - Account - Log In"]
...
${ACCOUNT_CONFIRMED} =  css: #app > div > div.Area.css-1dkobwk > div > div > div > div.Navbar-container > nav.Navbar-desktop > div.Navbar-profileItems > a.Navbar-account.Navbar-item.Navbar-modalToggle.is-noSelect > div.Navbar-label.Navbar-accountAuthenticated
