...
${LOGIN_BUTTON} =   css: #app > div > div.Area.css-1dkobwk > div > div > div > div.Navbar-modals > div.Navbar-modal.Navbar-accountModal.is-animated.is-scroll-blocking.is-open.is-displayed > div.Navbar-modalContent > div.Navbar-accountDropdownLoggedOut > div > a > button
${LOGIN_CONFIRMATION} =     css: body > div > div > h1
...
${ACCOUNT_CONFIRMED} =  css: #app > div > div.Area.css-1dkobwk > div > div > div > div.Navbar-modals > div.Navbar-modal.Navbar-accountModal.is-animated.is-scroll-blocking.is-open.is-displayed > div.Navbar-modalContent > div.Navbar-accountDropdownLoggedIn > div > div.Navbar-accountDropdownProfileInfo > div.Navbar-accountDropdownBattleTag
